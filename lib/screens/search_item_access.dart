...
class _ItemAccessState extends State<ItemAccess> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<LisaAccessItem> result = actualListAccess
        .where(
            (access) => access.todoDetails.toLowerCase().contains(widget.query))
        .toList();
      ...
      itemBuilder: (BuildContext context, int position) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            //   child: Text(
            //     '${access.todoDetails.substring(0, 1).toUpperCase()}',
            //     style: TextStyle(
            //       fontSize: 20.0,
            //       color: Colors.white,
